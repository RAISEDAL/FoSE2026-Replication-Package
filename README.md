...
This repository contains the replication package and supporting artifacts for the FoSE 2026 submission:
...
* **AgreementAnalysis.ipynb** – Inter-rater agreement computation and analysis.
...
2. Open the Jupyter notebooks in the order relevant to your analysis goals.
3. Execute all cells in each notebook to regenerate the results.
...
* Python version and library dependencies are specified within the notebooks (or via a requirements file if added).
